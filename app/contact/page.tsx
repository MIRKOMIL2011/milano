                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Milano Street, Tashkent, Uzbekistan</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@milanocafe.uz</p>
                      <p className="text-gray-600">orders@milanocafe.uz</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 space-y-1">
                        <p>
                          {t("monday")} - {t("friday")}: 9:00 AM - 10:00 PM
                        </p>
                        <p>
                          {t("saturday")} - {t("sunday")}: 10:00 AM - 11:00 PM
                        </p>
                      </div>
                    </div>
                  </div>
